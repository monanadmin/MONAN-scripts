...
echo ./convert_mpas ../monanprd/x1.${RESOLUTION}.init.nc ../monanprd/diag*nc
echo cdo settunits,hours -settaxis,${START_DATE_YYYYMMDD},${START_HH}:00,1hour latlon.nc surface.nc
...
echo ./convert_mpas ../monanprd/x1.${RESOLUTION}.init.nc ../monanprd/history.*.nc

echo cdo settunits,hours -settaxis,${START_DATE_YYYYMMDD},${START_HH}:00,3hour latlon.nc wind+pw_sfc.nc
...
# 3.  
#
echo ./convert_mpas ../monanprd/history.${END_DATE_YYYYMMDD}_${END_HH}.00.00.nc

#cdo -setreftime,1900-01-01,00:00:00,1day -setdate,1900-01-01 -setcalendar,standard latlon.nc history.2021-01-04_00.00.00.nc

# 24h
echo cdo settunits,hours -settaxis,${END_DATE_YYYYMMDD},${END_HH}:00,3hour latlon.nc history.${END_DATE_YYYYMMDD}_${END_HH}.00.00.nc
