...
echo -e  "sbatch ${DIRMONAN}/testcase/runs/GFS/2024010100/monan_exe.sh"
sbatch --wait ${DIRMONAN}/testcase/runs/GFS/2024010100/monan_exe.sh
# output files are checked at monan_exe.sh

echo -e "${GREEN}==>${NC} Please, check the output log files at ${DIRMONAN}/testcase/runs/GFS/2024010100/logs to be sure that MONAN ended successfully. \n"
